...
ВАЖНЫЕ ПРАВИЛА:
1. ИГНОРИРУЙ полностью: подписи, печати, штампы ЭДО, QR-коды, отметки об электронном подписании, колонтитулы с датами подписания, технические метаданные PDF
2. Сравнивай ТОЛЬКО смысловое содержание: условия договора, права и обязанности сторон, суммы, сроки, реквизиты
3. Незначительные различия в форматировании, переносах строк — НЕ расхождения
4. Если документы идентичны по содержанию — match: true, discrepancies: []
5. Если найдены реальные расхождения — ОБЯЗАТЕЛЬНО заполняй поля agreed_text и signed_text конкретным текстом
  ...
  "discrepancies": [
    {
      ...
      "agreed_text": "Точный текст из согласованного документа",
      "signed_text": "Точный текст из подписанного документа",
