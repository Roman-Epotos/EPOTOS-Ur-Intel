...
const FAQ_ITEMS = [
  { q: 'Как войти в систему?', a: 'Откройте Битрикс24 и найдите пункт «ЮрИнтел-Эпотос» в левом меню. Отдельная авторизация не требуется — система использует ваш аккаунт Битрикс24.' },
