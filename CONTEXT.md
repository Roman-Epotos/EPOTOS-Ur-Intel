...
Дата: 2026-06-01
Статус: Спринт 3 — активная разработка, Блок Б завершён
...
Типы активные:
  ...
  ⬜ Спецификация — запланирована (с нумерацией СПЕЦ)
...
✅ МОДУЛЬ «ПОМОЩЬ И ПОДДЕРЖКА» (01.06.2026):
  ...
  - last_seen записывается при фокусе поля ввода
...
=============================================================
10. ГДЕ ОСТАНОВИЛИСЬ (01.06.2026)
=============================================================
...
Следующая сессия — план:
  1. Добавить тип документа «Спецификация» (код СПЕЦ, нумерация, отображение)
  2. Интеграция проверки контрагентов через СБИС
  3. Подготовить шаблоны СПТ, ОС, Эпотос-К
